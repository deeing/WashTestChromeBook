...
public class HintManager : SingletonMonoBehaviour<HintManager>
{
    ...
    [SerializeField]
    private TutorialHintMenu wetHint;
    [SerializeField]
    ...
    public void ToggleWetHint(bool status)
    {
        wetHint.ToggleHintMenu(status);
    }

    public void ToggleSoapHint(bool status)
    {
        soapHint.ToggleHintMenu(status);
    }
